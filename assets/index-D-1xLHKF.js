 ...
 *
 * @license MIT
 */function Dc(){return Dc=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var r=arguments[e];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(t[n]=r[n])}return t},Dc.apply(this,arguments)}const Bb=K.createContext(null),rm=K.createContext(null),nm=K.createContext(null),im=K.createContext({outlet:null,matches:[],isDataRoute:!1});function om(){return K.useContext(nm)!=null}function qb(){return om()||Er(!1),K.useContext(nm).location}function Hb(t){K.useContext(rm).static||K.useLayoutEffect(t)}function wC(){let{isDataRoute:t}=K.useContext(im);return t?xC():bC()}function bC(){om()||Er(!1);let t=K.useContext(Bb),{basename:e,future:r,navigator:n}=K.useContext(rm),{matches:i}=K.useContext(im),{pathname:o}=qb(),s=JSON.stringify(pC(i,r.v7_relativeSplatPath)),l=K.useRef(!1);return Hb(()=>{l.current=!0}),K.useCallback(function(u,f){if(f===void 0&&(f={}),!l.current)return;if(typeof u=="number"){n.go(u);return}let p=mC(u,JSON.parse(s),o,f.relative==="path");t==null&&e!=="/"&&(p.pathname=p.pathname==="/"?e:gC([e,p.pathname])),(f.replace?n.replace:n.push)(p,f.state,f)},[e,n,s,o,t])}var Wb=function(t){return t.UseBlocker="useBlocker",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t}(Wb||{}),Kb=function(t){return t.UseBlocker="useBlocker",t.UseLoaderData="useLoaderData",t.UseActionData="useActionData",t.UseRouteError="useRouteError",t.UseNavigation="useNavigation",t.UseRouteLoaderData="useRouteLoaderData",t.UseMatches="useMatches",t.UseRevalidator="useRevalidator",t.UseNavigateStable="useNavigate",t.UseRouteId="useRouteId",t}(Kb||{});function EC(t){let e=K.useContext(Bb);return e||Er(!1),e}function IC(t){let e=K.useContext(im);return e||Er(!1),e}function TC(t){let e=IC(),r=e.matches[e.matches.length-1];return r.route.id||Er(!1),r.route.id}function xC(){let{router:t}=EC(Wb.UseNavigateStable),e=TC(Kb.UseNavigateStable),r=K.useRef(!1);return Hb(()=>{r.current=!0}),K.useCallback(function(i,o){o===void 0&&(o={}),r.current&&(typeof i=="number"?t.navigate(i):t.navigate(i,Dc({fromRouteId:e},o)))},[t,e])}function AC(t,e){t==null||t.v7_startTransition,t==null||t.v7_relativeSplatPath}function SC(t){let{basename:e="/",children:r=null,location:n,navigationType:i=si.Pop,navigator:o,static:s=!1,future:l}=t;om()&&Er(!1);let c=e.replace(/^\/*/,"/"),u=K.useMemo(()=>({basename:c,navigator:o,static:s,future:Dc({v7_relativeSplatPath:!1},l)}),[c,l,o,s]);typeof n=="string"&&(n=ka(n));let{pathname:f="/",search:p="",hash:m="",state:E=null,key:A="default"}=n,P=K.useMemo(()=>{let N=cC(f,c);return N==null?null:{location:{pathname:N,search:p,hash:m,state:E,key:A},navigationType:i}},[c,f,p,m,E,A,i]);return P==null?null:K.createElement(rm.Provider,{value:u},K.createElement(nm.Provider,{children:r,value:P}))}new Promise(()=>{});/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ut="WebChannelConnection";class y2 extends class{constructor(r){this.databaseInfo=r,this.databaseId=r.databaseId;const n=r.ssl?"https":"http",i=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Do=n+"://"+r.host,this.vo=`projects/${i}/databases/${o}`,this.Co=this.databaseId.database==="(default)"?`project_id=${i}`:`project_id=${i}&database_id=${o}`}get Fo(){return!1}Mo(r,n,i,o,s){const l=Xd(),c=this.xo(r,n.toUriEncodedString());Q("RestConnection",`Sending RPC '${r}' ${l}:`,c,i);const u={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(u,o,s),this.No(r,c,u,i).then(f=>(Q("RestConnection",`Received RPC '${r}' ${l}: `,f),f),f=>{throw Io("RestConnection",`RPC '${r}' ${l} failed with error: `,f,"url: ",c,"request:",i),f})}Lo(r,n,i,o,s,l){return this.Mo(r,n,i,o,s)}Oo(r,n,i){r["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Fo}(),r["Content-Type"]="text/plain",this.databaseInfo.appId&&(r["X-Firebase-GMPID"]=this.databaseInfo.appId),n&&n.headers.forEach((o,s)=>r[s]=o),i&&i.headers.forEach((o,s)=>r[s]=o)}xo(r,n){const i=g2[r];return`${this.Do}/v1/${n}:${i}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,r,n,i){const o=Xd();return new Promise((s,l)=>{const c=new zE;c.setWithCredentials(!0),c.listenOnce(jE.COMPLETE,()=>{try{switch(c.getLastErrorCode()){case nc.NO_ERROR:const f=c.getResponseJson();Q(ut,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(f)),s(f);break;case nc.TIMEOUT:Q(ut,`RPC '${e}' ${o} timed out`),l(new G(L.DEADLINE_EXCEEDED,"Request time out"));break;case nc.HTTP_ERROR:const p=c.getStatus();if(Q(ut,`RPC '${e}' ${o} failed with status:`,p,"response text:",c.getResponseText()),p>0){let m=c.getResponseJson();Array.isArray(m)&&(m=m[0]);const E=m==null?void 0:m.error;if(E&&E.status&&E.message){const A=function(N){const b=N.toLowerCase().replace(/_/g,"-");return Object.values(L).indexOf(b)>=0?b:L.UNKNOWN}(E.status);l(new G(A,E.message))}else l(new G(L.UNKNOWN,"Server responded with status "+c.getStatus()))}else l(new G(L.UNAVAILABLE,"Connection failed."));break;default:te()}}finally{Q(ut,`RPC '${e}' ${o} completed.`)}});const u=JSON.stringify(i);Q(ut,`RPC '${e}' ${o} sending request:`,i),c.send(r,"POST",u,n,15)})}Bo(e,r,n){const i=Xd(),o=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],s=HE(),l=qE(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(c.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Oo(c.initMessageHeaders,r,n),c.encodeInitMessageHeaders=!0;const f=o.join("");Q(ut,`Creating RPC '${e}' stream ${i}: ${f}`,c);const p=s.createWebChannel(f,c);let m=!1,E=!1;const A=new v2({Io:N=>{E?Q(ut,`Not sending because RPC '${e}' stream ${i} is closed:`,N):(m||(Q(ut,`Opening RPC '${e}' stream ${i} transport.`),p.open(),m=!0),Q(ut,`RPC '${e}' stream ${i} sending:`,N),p.send(N))},To:()=>p.close()}),P=(N,b,y)=>{N.listen(b,x=>{try{y(x)}catch(D){setTimeout(()=>{throw D},0)}})};return P(p,Es.EventType.OPEN,()=>{E||(Q(ut,`RPC '${e}' stream ${i} transport opened.`),A.yo())}),P(p,Es.EventType.CLOSE,()=>{E||(E=!0,Q(ut,`RPC '${e}' stream ${i} transport closed`),A.So())}),P(p,Es.EventType.ERROR,N=>{E||(E=!0,Io(ut,`RPC '${e}' stream ${i} transport errored:`,N),A.So(new G(L.UNAVAILABLE,"The operation could not be completed")))}),P(p,Es.EventType.MESSAGE,N=>{var b;if(!E){const y=N.data[0];me(!!y);const x=y,D=x.error||((b=x[0])===null||b===void 0?void 0:b.error);if(D){Q(ut,`RPC '${e}' stream ${i} received error:`,D);const U=D.status;let z=function(w){const I=Me[w];if(I!==void 0)return gI(I)}(U),_=D.message;z===void 0&&(z=L.INTERNAL,_="Unknown error status: "+U+" with message "+D.message),E=!0,A.So(new G(z,_)),p.close()}else Q(ut,`RPC '${e}' stream ${i} received:`,y),A.bo(y)}}),P(l,BE.STAT_EVENT,N=>{N.stat===Ef.PROXY?Q(ut,`RPC '${e}' stream ${i} detected buffering proxy`):N.stat===Ef.NOPROXY&&Q(ut,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{A.wo()},0),A}}function Jd(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class b2 extends class{}{constructor(e,r,n,i){super(),this.authCredentials=e,this.appCheckCredentials=r,this.connection=n,this.serializer=i,this.y_=!1}w_(){if(this.y_)throw new G(L.FAILED_PRECONDITION,"The client has already been terminated.")}Mo(e,r,n,i){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([o,s])=>this.connection.Mo(e,Rf(r,n),i,o,s)).catch(o=>{throw o.name==="FirebaseError"?(o.code===L.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),o):new G(L.UNKNOWN,o.toString())})}Lo(e,r,n,i,o){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([s,l])=>this.connection.Lo(e,Rf(r,n),i,s,l,o)).catch(s=>{throw s.name==="FirebaseError"?(s.code===L.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),s):new G(L.UNKNOWN,s.toString())})}terminate(){this.y_=!0,this.connection.terminate()}}class E2{constructor(e,r){this.asyncQueue=e,this.onlineStateHandler=r,this.state="Unknown",this.S_=0,this.b_=null,this.D_=!0}v_(){this.S_===0&&(this.C_("Unknown"),this.b_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.b_=null,this.F_("Backend didn't respond within 10 seconds."),this.C_("Offline"),Promise.resolve())))}M_(e){this.state==="Online"?this.C_("Unknown"):(this.S_++,this.S_>=1&&(this.x_(),this.F_(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.C_("Offline")))}set(e){this.x_(),this.S_=0,e==="Online"&&(this.D_=!1),this.C_(e)}C_(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}F_(e){const r=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function WI(t,e,r){if(!r)throw new G(L.INVALID_ARGUMENT,`Function ${t}() cannot be called with an empty ${e}.`)}function cO(t,e,r,n){if(e===!0&&n===!0)throw new G(L.INVALID_ARGUMENT,`${t} and ${r} cannot be used together.`)}function B_(t){if(!X.isDocumentKey(t))throw new G(L.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`)}function q_(t){if(X.isDocumentKey(t))throw new G(L.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`)}function Pu(t){if(t===void 0)return"undefined";if(t===null)return"null";if(typeof t=="string")return t.length>20&&(t=`${t.substring(0,20)}...`),JSON.stringify(t);if(typeof t=="number"||typeof t=="boolean")return""+t;if(typeof t=="object"){if(t instanceof Array)return"an array";{const e=function(n){return n.constructor?n.constructor.name:null}(t);return e?`a custom ${e} object`:"an object"}}return typeof t=="function"?"a function":te()}function Ar(t,e){if("_delegate"in t&&(t=t._delegate),!(t instanceof e)){if(e.name===t.constructor.name)throw new G(L.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const r=Pu(t);throw new G(L.INVALID_ARGUMENT,`Expected type '${e.name}', but it was: ${r}`)}}return t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class H_{constructor(e){var r,n;if(e.host===void 0){if(e.ssl!==void 0)throw new G(L.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host="firestore.googleapis.com",this.ssl=!0}else this.host=e.host,this.ssl=(r=e.ssl)===null||r===void 0||r;if(this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=41943040;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<1048576)throw new G(L.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}cO("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=HI((n=e.experimentalLongPollingOptions)!==null&&n!==void 0?n:{}),function(o){if(o.timeoutSeconds!==void 0){if(isNaN(o.timeoutSeconds))throw new G(L.INVALID_ARGUMENT,`invalid long polling timeout: ${o.timeoutSeconds} (must not be NaN)`);if(o.timeoutSeconds<5)throw new G(L.INVALID_ARGUMENT,`invalid long polling timeout: ${o.timeoutSeconds} (minimum allowed value is 5)`);if(o.timeoutSeconds>30)throw new G(L.INVALID_ARGUMENT,`invalid long polling timeout: ${o.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&function(n,i){return n.timeoutSeconds===i.timeoutSeconds}(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class Nu{constructor(e,r,n,i){this._authCredentials=e,this._appCheckCredentials=r,this._databaseId=n,this._app=i,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new H_({}),this._settingsFrozen=!1,this._terminateTask="notTerminated"}get app(){if(!this._app)throw new G(L.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new G(L.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new H_(e),e.credentials!==void 0&&(this._authCredentials=function(n){if(!n)return new TP;switch(n.type){case"firstParty":return new CP(n.sessionIndex||"0",n.iamToken||null,n.authTokenFactory||null);case"provider":return n.client;default:throw new G(L.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(r){const n=j_.get(r);n&&(Q("ComponentProvider","Removing Datastore"),j_.delete(r),n.terminate())}(this),Promise.resolve()}}function uO(t,e,r,n={}){var i;const o=(t=Ar(t,Nu))._getSettings(),s=`${e}:${r}`;if(o.host!=="firestore.googleapis.com"&&o.host!==s&&Io("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),t._setSettings(Object.assign(Object.assign({},o),{host:s,ssl:!1})),n.mockUserToken){let l,c;if(typeof n.mockUserToken=="string")l=n.mockUserToken,c=dt.MOCK_USER;else{l=jC(n.mockUserToken,(i=t._app)===null||i===void 0?void 0:i.options.projectId);const u=n.mockUserToken.sub||n.mockUserToken.user_id;if(!u)throw new G(L.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");c=new dt(u)}t._authCredentials=new xP(new WE(l,c))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ko{constructor(e){this._byteString=e}static fromBase64String(e){try{return new ko(rt.fromBase64String(e))}catch(r){throw new G(L.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+r)}}static fromUint8Array(e){return new ko(rt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ou{constructor(...e){for(let r=0;r<e.length;++r)if(e[r].length===0)throw new G(L.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Je(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qm{constructor(e,r){if(!isFinite(e)||e<-90||e>90)throw new G(L.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(r)||r<-180||r>180)throw new G(L.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+r);this._lat=e,this._long=r}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return he(this._lat,e._lat)||he(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const Dr={ArrowDown:"ArrowDown",ArrowLeft:"ArrowLeft",ArrowUp:"ArrowUp",ArrowRight:"ArrowRight",Home:"Home",End:"End"};class kV{constructor(e){this.handleKeydown=f=>{const p=f.key;if(f.defaultPrevented||!this.isNavigableKey(p))return;const m=this.items;if(!m.length)return;const E=mh(m,this.isActivatable);f.preventDefault();const A=this.isRtl(),P=A?Dr.ArrowRight:Dr.ArrowLeft,N=A?Dr.ArrowLeft:Dr.ArrowRight;let b=null;switch(p){case Dr.ArrowDown:case N:b=bw(m,E,this.isActivatable,this.wrapNavigation());break;case Dr.ArrowUp:case P:b=Ew(m,E,this.isActivatable,this.wrapNavigation());break;case Dr.Home:b=QT(m,this.isActivatable);break;case Dr.End:b=YT(m,this.isActivatable);break}b&&E&&E.item!==b&&(E.item.tabIndex=-1)},this.onDeactivateItems=()=>{const f=this.items;for(const p of f)this.deactivateItem(p)},this.onRequestActivation=f=>{this.onDeactivateItems();const p=f.target;this.activateItem(p),p.focus()},this.onSlotchange=()=>{const f=this.items;let p=!1;for(const E of f){if(!E.disabled&&E.tabIndex>-1&&!p){p=!0,E.tabIndex=0;continue}E.tabIndex=-1}if(p)return;const m=XT(f,this.isActivatable);m&&(m.tabIndex=0)};const{isItem:r,getPossibleItems:n,isRtl:i,deactivateItem:o,activateItem:s,isNavigableKey:l,isActivatable:c,wrapNavigation:u}=e;this.isItem=r,this.getPossibleItems=n,this.isRtl=i,this.deactivateItem=o,this.activateItem=s,this.isNavigableKey=l,this.isActivatable=c,this.wrapNavigation=u??(()=>!0)}get items(){const e=this.getPossibleItems(),r=[];for(const n of e){if(this.isItem(n)){r.push(n);continue}const o=n.item;o&&this.isItem(o)&&r.push(o)}return r}activateNextItem(){const e=this.items,r=mh(e,this.isActivatable);return r&&(r.item.tabIndex=-1),bw(e,r,this.isActivatable,this.wrapNavigation())}activatePreviousItem(){const e=this.items,r=mh(e,this.isActivatable);return r&&(r.item.tabIndex=-1),Ew(e,r,this.isActivatable,this.wrapNavigation())}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class Hu extends Te{constructor(){super(...arguments),this.inset=!1,this.insetStart=!1,this.insetEnd=!1}}R([F({type:Boolean,reflect:!0})],Hu.prototype,"inset",void 0);R([F({type:Boolean,reflect:!0,attribute:"inset-start"})],Hu.prototype,"insetStart",void 0);R([F({type:Boolean,reflect:!0,attribute:"inset-end"})],Hu.prototype,"insetEnd",void 0);/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const a4=t=>t.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),l4=(t,e)=>{const r=K.forwardRef(({color:n="currentColor",size:i=24,strokeWidth:o=2,absoluteStrokeWidth:s,className:l="",children:c,...u},f)=>K.createElement("svg",{ref:f,...s4,width:i,height:i,stroke:n,strokeWidth:s?Number(o)*24/Number(i):o,className:["lucide",`lucide-${a4(t)}`,l].join(" "),...u},[...e.map(([p,m])=>K.createElement(p,m)),...Array.isArray(c)?c:[c]]));return r.displayName=`${t}`,r};/**
 * @license lucide-react v0.303.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const c4=l4("PowerOff",[["path",{d:"M18.36 6.64A9 9 0 0 1 20.77 15",key:"dxknvb"}],["path",{d:"M6.16 6.16a9 9 0 1 0 12.68 12.68",key:"1x7qb5"}],["path",{d:"M12 2v4",key:"3427ic"}],["path",{d:"m2 2 20 20",key:"1ooewy"}]]),u4=["Bartender","Barback","Server","Manager","Security","Runner","Busser","Host"],xw=[{id:"ice",label:"ICE",icon:"ac_unit"},{id:"glass",label:"GLASSWARE",icon:"wine_bar",children:[{id:"rocks",label:"ROCKS"},{id:"collins",label:"COLLINS"},{id:"pint",label:"PINT"},{id:"coupe",label:"COUPE"},{id:"shot",label:"SHOT GLASS"},{id:"wine",label:"WINE GLASS"}]},{id:"fruit",label:"FRUIT / GARNISH",icon:"restaurant",children:[{id:"lime",label:"LIMES"},{id:"lemon",label:"LEMONS"},{id:"orange",label:"ORANGES"},{id:"cherry",label:"CHERRIES"},{id:"olive",label:"OLIVES"},{id:"mint",label:"MINT"}]},{id:"restock",label:"RESTOCK WELL",icon:"liquor",children:[{id:"vodka",label:"VODKA"},{id:"gin",label:"GIN"},{id:"tequila",label:"TEQUILA"},{id:"rum",label:"RUM"},{id:"whiskey",label:"WHISKEY"},{id:"cordial",label:"MIXERS"},{id:"beer",label:"BEER"}]},{id:"keg",label:"KEG KICKED",icon:"keg"},{id:"trash",label:"TRASH / SPILL",icon:"delete"},{id:"security",label:"SECURITY",icon:"security"},{id:"manager",label:"MANAGER",icon:"manage_accounts"}],d4=async t=>{if(!t||t.length<3)return[];try{return await(await fetch(`https://nominatim.openstreetmap.org/search?format=json&q=${encodeURIComponent(t)}&addressdetails=1&limit=5`,{headers:{"User-Agent":"BarBackerPWA/1.0"}})).json()}catch{return[]}},h4=({onJoin:t})=>{const[e,r]=K.useState("search"),[n,i]=K.useState(""),[o,s]=K.useState([]),[l,c]=K.useState(!1),[u,f]=K.useState(""),[p,m]=K.useState("");K.useEffect(()=>{if(e!=="search")return;const A=setTimeout(async()=>{n.length>=3?(c(!0),s(await d4(n)),c(!1)):s([])},500);return()=>clearTimeout(A)},[n,e]);const E=A=>{t({id:`osm_${A.place_id}`,name:A.name||A.display_name.split(",")[0],address:A.display_name,osmId:A.osm_id.toString(),status:"verified"})};return M.jsxs("div",{className:"w-full max-w-sm space-y-6",children:[M.jsxs("md-chip-set",{children:[M.jsx("md-filter-chip",{label:"Search",selected:e==="search",onClick:()=>r("search")}),M.jsx("md-filter-chip",{label:"Create Temp",selected:e==="create",onClick:()=>r("create")})]}),e==="search"?M.jsxs("div",{className:"space-y-4",children:[M.jsx("md-filled-text-field",{label:"Search OpenStreetMap",value:n,onInput:A=>i(A.target.value),type:"search",children:M.jsx("md-icon",{slot:"leading-icon",children:"search"})}),l&&M.jsx("md-circular-progress",{indeterminate:!0}),o.length>0&&M.jsx("md-list",{className:"bg-[#1E1E1E] rounded-xl overflow-hidden",children:o.map(A=>M.jsxs("md-list-item",{type:"button",onClick:()=>E(A),children:[M.jsx("div",{slot:"headline",children:A.name||A.display_name.split(",")[0]}),M.jsx("div",{slot:"supporting-text",children:A.display_name}),M.jsx("md-icon",{slot:"end",children:"arrow_forward"})]},A.place_id))})]}):M.jsxs("form",{onSubmit:A=>{A.preventDefault(),u&&t({id:`temp_${Date.now()}`,name:u,address:p,status:"temporary"})},className:"space-y-4",children:[M.jsx("md-filled-text-field",{label:"Bar Name",value:u,onInput:A=>f(A.target.value),required:!0}),M.jsx("md-filled-text-field",{label:"Location (City/Address)",value:p,onInput:A=>m(A.target.value)}),M.jsx("md-filled-button",{type:"submit",children:"Create Bar"})]})]})},f4=({onSelect:t})=>{const[e,r]=K.useState(""),[n,i]=K.useState("");return M.jsxs("div",{className:"w-full max-w-sm space-y-6 animate-in fade-in slide-in-from-bottom-4",children:[M.jsxs("div",{className:"text-center space-y-2",children:[M.jsx("h2",{className:"text-2xl font-bold text-white",children:"Identification"}),M.jsx("p",{className:"text-gray-500",children:"Name and Rank, soldier."})]}),M.jsx("md-filled-text-field",{label:"Display Name (e.g. 'Angry Steve')",value:n,onInput:o=>i(o.target.value),required:!0}),M.jsx("div",{className:"bg-[#1E1E1E] rounded-xl overflow-hidden border border-gray-800 max-h-60 overflow-y-auto",children:u4.map(o=>{const s=e===o;return M.jsxs("div",{onClick:()=>r(o),className:`p-4 flex items-center justify-between cursor-pointer border-b border-gray-800 last:border-0 hover:bg-white/5 transition-colors ${s?"bg-white/10 border-l-4 border-l-white":""}`,children:[M.jsxs("div",{className:"flex items-center gap-3",children:[M.jsx("md-icon",{children:o==="Bartender"?"local_bar":"person"}),M.jsx("span",{className:`font-medium text-lg ${s?"text-white":"text-gray-400"}`,children:o})]}),s&&M.jsx("md-icon",{className:"text-white",children:"check_circle"})]},o)})}),M.jsx("div",{onClick:()=>{e&&n&&t(e,n)},className:"w-full",children:M.jsx("md-filled-button",{disabled:!e||!n||void 0,style:{pointerEvents:"none",width:"100%"},children:"Clock In"})})]})};function p4(){const[t,e]=K.useState(null),[r,n]=K.useState(null),[i,o]=K.useState(!1),[s,l]=NC(),c=s.get("bar")||localStorage.getItem("barId"),[u,f]=K.useState(c),[p,m]=K.useState(""),[E,A]=K.useState(null),[P,N]=K.useState(""),[b,y]=K.useState([]),[x,D]=K.useState(xw),[U,z]=K.useState(null),[_,v]=K.useState([]),w=K.useRef(null),[I,S]=K.useState(!1);K.useEffect(()=>{const q=uR(fs,ee=>{e(ee),ee&&lL().then(fe=>fe&&z(fe))});return cL().then(()=>{navigator.vibrate&&navigator.vibrate([500,200,500]),new Audio("/alert.mp3").play().catch(()=>{})}),()=>q()},[]),K.useEffect(()=>{if(!t||!u)return;l({bar:u}),localStorage.setItem("barId",u);const q=vr(ir,`bars/${u}/users`,t.uid),ee=vr(ir,`bars/${u}/tokens`,t.uid);(async()=>{U&&(await Rl(ee,{token:U,updated:Jn()}),await eh(q,{status:"active",lastSeen:Jn()}).catch(()=>{}))})();const Jt=th(q,Ke=>{if(Ke.exists()){const tr=Ke.data();A(tr.role),N(tr.displayName||"Unknown")}else A(null)}),Zt=th(vr(ir,"bars",u),Ke=>{if(Ke.exists()){const tr=Ke.data();m(tr.name),tr.buttons&&D([...xw,...tr.buttons])}}),er=th(EO(W_(ir,"requests"),IO("barId","==",u),TO("timestamp","desc")),Ke=>y(Ke.docs.map(tr=>({id:tr.id,...tr.data()}))));return()=>{Jt(),Zt(),er()}},[t,u,U,l]),K.useEffect(()=>(w.current&&clearTimeout(w.current),_.length>0&&(w.current=setTimeout(()=>{const q=_.map(ee=>ee.label).join(": ");it(`${q} (Ask Me)`),v([])},6e4)),()=>{w.current&&clearTimeout(w.current)}),[_]);const C=async(q,ee)=>{!t||!u||(await Rl(vr(ir,`bars/${u}/users`,t.uid),{role:q,displayName:ee,email:t.email,status:"active",joinedAt:Jn(),lastSeen:Jn()},{merge:!0}),U&&await Rl(vr(ir,`bars/${u}/tokens`,t.uid),{token:U,updated:Jn()}))},T=async()=>{!t||!u||(await CO(vr(ir,`bars/${u}/tokens`,t.uid)),await eh(vr(ir,`bars/${u}/users`,t.uid),{status:"off_clock"}),f(null),localStorage.removeItem("barId"),S(!1))},it=async q=>{!t||!u||(navigator.vibrate&&navigator.vibrate(100),await kO(W_(ir,"requests"),{barId:u,label:q,requesterId:t.uid,requesterName:P,requesterRole:E,status:"pending",timestamp:Jn(),lastNotification:Jn()}))},Rr=async q=>{await eh(vr(ir,"requests",q),{status:"claimed",claimedBy:t==null?void 0:t.uid,claimerName:P})},Kn=async q=>{q.preventDefault();const ee=new FormData(q.target);try{i?await sR(fs,ee.get("email"),ee.get("password")):await aR(fs,ee.get("email"),ee.get("password"))}catch(fe){n(fe.message)}},Xt=async()=>{try{await PR(fs,aL)}catch(q){n(q.message)}};if(!t)return M.jsxs("div",{className:"min-h-screen flex flex-col items-center justify-center p-6 space-y-8 bg-black",children:[M.jsx("h1",{className:"text-4xl font-bold tracking-widest text-white",children:"BARBACKER"}),r&&M.jsx("div",{className:"text-red-400 p-2 border border-red-800 rounded",children:r}),M.jsxs("form",{onSubmit:Kn,className:"w-full max-w-sm space-y-4",children:[M.jsx("md-filled-text-field",{label:"Email",name:"email",type:"email",required:!0}),M.jsx("md-filled-text-field",{label:"Password",name:"password",type:"password",required:!0}),M.jsx("md-filled-button",{type:"submit",children:i?"Create Account":"Sign In"})]}),M.jsxs("div",{className:"flex gap-4 items-center",children:[M.jsx("md-text-button",{onClick:()=>o(!i),children:i?"Login":"Register"}),M.jsxs("md-outlined-button",{onClick:Xt,children:[M.jsx("md-icon",{slot:"icon",children:"mail"}),"Google"]})]})]});if(!u)return M.jsxs("div",{className:"min-h-screen flex flex-col items-center justify-center p-6 space-y-6 bg-black",children:[M.jsxs("div",{className:"text-center",children:[M.jsx("h2",{className:"text-2xl font-bold text-white mb-1",children:"Select Bar"}),M.jsxs("p",{className:"text-gray-500 text-sm",children:["You are ",t.email]})]}),M.jsx("md-text-button",{onClick:()=>dR(fs),children:"Sign Out"}),M.jsx(h4,{onJoin:async q=>{q.id&&(q.status==="temporary"&&await Rl(vr(ir,"bars",q.id),{name:q.name,address:q.address||"",status:"temporary",buttons:[]},{merge:!0}),f(q.id))}})]});if(!E)return M.jsxs("div",{className:"min-h-screen flex flex-col items-center justify-center p-6 space-y-6 bg-black",children:[M.jsx("md-icon-button",{onClick:()=>{f(null),localStorage.removeItem("barId")},children:M.jsx("md-icon",{children:"arrow_back"})}),M.jsx(f4,{onSelect:C})]});const H=b.filter(q=>q.status==="pending"),Z=b.filter(q=>q.status!=="pending").slice(0,20),ie=_.length>0?_[_.length-1].children||[]:x;return M.jsxs("div",{className:"min-h-screen pb-24 bg-black relative overflow-hidden",children:[M.jsxs("md-dialog",{open:I,onClose:()=>S(!1),children:[M.jsx("div",{slot:"headline",children:"Abandon Ship?"}),M.jsx("div",{slot:"content",children:"Going off clock stops all notifications. The bar will be unprotected. Are you sure?"}),M.jsxs("div",{slot:"actions",children:[M.jsx("md-text-button",{onClick:()=>S(!1),children:"Stay"}),M.jsx("md-filled-button",{onClick:T,class:"btn-alert",children:"Leave"})]})]}),M.jsxs("div",{className:"flex justify-between items-center p-4 bg-[#121212] sticky top-0 z-10 border-b border-[#333]",children:[M.jsxs("div",{className:"flex flex-col",children:[M.jsx("span",{className:"font-bold text-lg text-white tracking-wide",children:p}),M.jsxs("div",{className:"flex items-center gap-2 text-xs text-gray-400",children:[M.jsx("span",{className:"text-white font-bold",children:P}),M.jsx("span",{className:"bg-gray-800 px-1 rounded",children:E})]})]}),M.jsx("div",{className:"flex gap-2",children:M.jsx("md-icon-button",{onClick:()=>S(!0),title:"Go Off Clock",children:M.jsx(c4,{className:"text-gray-500 hover:text-red-500"})})})]}),_.length>0&&M.jsxs("div",{className:"fixed inset-0 bg-black/95 z-50 flex flex-col p-6 animate-in fade-in duration-300",children:[M.jsxs("div",{className:"flex items-center gap-4 mb-8",children:[M.jsx("md-icon-button",{onClick:()=>v([]),children:M.jsx("md-icon",{children:"close"})}),M.jsx("span",{className:"text-xl font-medium text-gray-200",children:_.map(q=>q.label).join(" > ")})]}),M.jsx("div",{className:"grid grid-cols-2 gap-4",children:ie.map(q=>M.jsx("md-filled-tonal-button",{onClick:()=>{q.children?v([..._,q]):(it([..._,q].map(ee=>ee.label).join(": ")),v([]))},style:{height:"100px",fontSize:"18px"},children:q.label},q.id))})]}),M.jsx("div",{className:"grid grid-cols-2 gap-3 p-4",children:x.map(q=>{const ee=H.some(fe=>fe.label.startsWith(q.label));return M.jsx("md-filled-tonal-button",{onClick:()=>{q.children?v([..._,q]):it(q.label)},class:ee?"btn-alert":"",style:{height:"120px"},children:M.jsxs("div",{className:"flex flex-col items-center gap-2",children:[M.jsx("md-icon",{style:{fontSize:32},children:q.icon||"circle"}),M.jsx("span",{className:"text-lg font-bold leading-none",children:q.label}),ee&&M.jsx("span",{className:"text-xs opacity-80",children:"PENDING"})]})},q.id)})}),M.jsx("div",{className:"px-4 mt-4",children:H.map(q=>M.jsxs("div",{onClick:()=>Rr(q.id),className:"mb-2 p-4 bg-[#2C1A1A] border-l-4 border-red-500 rounded-r-lg flex justify-between items-center cursor-pointer active:bg-red-900/40 transition-colors",children:[M.jsxs("div",{className:"flex flex-col",children:[M.jsx("span",{className:"font-medium text-red-100",children:q.label}),M.jsxs("span",{className:"text-xs text-red-400",children:[q.requesterName," (",q.requesterRole,")"]})]}),M.jsx("md-filled-button",{class:"btn-alert",style:{height:"32px"},children:"CLAIM"})]},q.id))}),M.jsxs("div",{className:"px-4 mt-8 pb-10",children:[M.jsx("div",{className:"text-xs font-bold text-gray-600 mb-2 uppercase tracking-widest",children:"Shift Log"}),M.jsx("md-list",{className:"bg-transparent",children:Z.map(q=>M.jsxs("md-list-item",{children:[M.jsx("div",{slot:"headline",className:"text-gray-400",children:q.label}),M.jsxs("div",{slot:"supporting-text",className:"text-xs text-gray-600",children:["Asked by ",q.requesterName," • Claimed by ",q.claimerName||"Someone"]}),M.jsx("md-icon",{slot:"start",className:"text-green-800",children:"check_circle"})]},q.id))})]})]})}Fb(document.getElementById("root")).render(M.jsx(K.StrictMode,{children:M.jsx(PC,{children:M.jsx(p4,{})})}));
