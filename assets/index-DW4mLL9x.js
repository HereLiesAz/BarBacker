 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const c4=l4("PowerOff",[["path",{d:"M18.36 6.64A9 9 0 0 1 20.77 15",key:"dxknvb"}],["path",{d:"M6.16 6.16a9 9 0 1 0 12.68 12.68",key:"1x7qb5"}],["path",{d:"M12 2v4",key:"3427ic"}],["path",{d:"m2 2 20 20",key:"1ooewy"}]]),u4=["Bartender","Barback","Server","Manager","Security","Runner"],x0=[{id:"ice",label:"ICE",icon:"ac_unit"},{id:"glass",label:"GLASSWARE",icon:"wine_bar",children:[{id:"rocks",label:"ROCKS"},{id:"collins",label:"COLLINS"},{id:"pint",label:"PINT"},{id:"coupe",label:"COUPE"},{id:"shot",label:"SHOT GLASS"},{id:"wine",label:"WINE GLASS"}]},{id:"fruit",label:"FRUIT / GARNISH",icon:"restaurant",children:[{id:"lime",label:"LIMES"},{id:"lemon",label:"LEMONS"},{id:"orange",label:"ORANGES"},{id:"cherry",label:"CHERRIES"},{id:"olive",label:"OLIVES"},{id:"mint",label:"MINT"}]},{id:"restock",label:"RESTOCK WELL",icon:"liquor",children:[{id:"vodka",label:"VODKA"},{id:"gin",label:"GIN"},{id:"tequila",label:"TEQUILA"},{id:"rum",label:"RUM"},{id:"whiskey",label:"WHISKEY"},{id:"cordial",label:"MIXERS"},{id:"beer",label:"BEER"}]},{id:"keg",label:"KEG KICKED",icon:"keg"},{id:"trash",label:"TRASH / SPILL",icon:"delete"},{id:"security",label:"SECURITY",icon:"security"},{id:"manager",label:"MANAGER",icon:"manage_accounts"}],d4=({onJoin:t})=>{const[e,r]=Q.useState("search"),[n,i]=Q.useState(""),o=s=>{s.preventDefault(),t({name:n,status:"temporary"})};return F.jsxs("div",{className:"space-y-4",children:[e==="search"?F.jsx("md-filled-text-field",{label:"Search OpenStreetMap",value:n,onInput:s=>i(s.target.value),type:"search"}):F.jsxs("form",{onSubmit:o,children:[F.jsx("md-filled-text-field",{label:"Bar Name",value:n,onInput:s=>i(s.target.value)}),F.jsx("md-filled-button",{type:"submit",children:"Create Bar"})]}),F.jsxs("div",{className:"flex justify-center gap-4",children:[e==="search"?F.jsx("md-filled-button",{onClick:()=>r("search"),children:"Search"}):F.jsx("md-outlined-button",{onClick:()=>r("search"),children:"Search"}),e==="create"?F.jsx("md-filled-button",{onClick:()=>r("create"),children:"Create Temp"}):F.jsx("md-outlined-button",{onClick:()=>r("create"),children:"Create Temp"})]})]})},h4=({onSelect:t})=>{const[e,r]=Q.useState(""),[n,i]=Q.useState("");return F.jsxs("div",{className:"w-full max-w-sm space-y-6 animate-in fade-in slide-in-from-bottom-4",children:[F.jsxs("div",{className:"text-center space-y-2",children:[F.jsx("h2",{className:"text-2xl font-bold text-white",children:"Identification"}),F.jsx("p",{className:"text-gray-500",children:"Name and Rank, soldier."})]}),F.jsx("md-filled-text-field",{label:"Display Name (e.g. 'Angry Steve')",value:n,onInput:o=>i(o.target.value),required:!0}),F.jsx("div",{className:"bg-[#1E1E1E] rounded-xl overflow-hidden border border-gray-800 max-h-60 overflow-y-auto",children:u4.map(o=>F.jsxs("div",{onClick:()=>r(o),className:`p-4 flex items-center justify-between cursor-pointer border-b border-gray-800 last:border-0 hover:bg-white/5 ${e===o?"bg-white/10":""}`,children:[F.jsxs("div",{className:"flex items-center gap-3",children:[F.jsx("md-icon",{children:o==="Bartender"?"local_bar":"person"}),F.jsx("span",{className:"font-medium text-lg",children:o})]}),F.jsx("md-radio",{checked:e===o,"touch-target":"wrapper"})]},o))}),F.jsx("md-filled-button",{disabled:!e||!n||void 0,onClick:()=>t(e,n),children:"Clock In"})]})};function f4(){const[t,e]=Q.useState(null),[r,n]=Q.useState(null),[i,o]=Q.useState(!1),[s,l]=NC(),c=s.get("bar")||localStorage.getItem("barId"),[u,f]=Q.useState(c),[p,m]=Q.useState(""),[T,S]=Q.useState(null),[P,N]=Q.useState(""),[b,y]=Q.useState([]),[x,D]=Q.useState(x0),[U,z]=Q.useState(null),[_,v]=Q.useState([]),w=Q.useRef(null),[E,A]=Q.useState(!1);Q.useEffect(()=>{const q=uR(fs,ee=>{e(ee),ee&&lL().then(fe=>fe&&z(fe))});return cL().then(()=>{navigator.vibrate&&navigator.vibrate([500,200,500]),new Audio("/alert.mp3").play().catch(()=>{})}),()=>q()},[]),Q.useEffect(()=>{if(!t||!u)return;l({bar:u}),localStorage.setItem("barId",u);const q=vr(ir,`bars/${u}/users`,t.uid),ee=vr(ir,`bars/${u}/tokens`,t.uid);(async()=>{U&&(await Rl(ee,{token:U,updated:Jn()}),await eh(q,{status:"active",lastSeen:Jn()}).catch(()=>{}))})();const Jt=th(q,Ke=>{if(Ke.exists()){const tr=Ke.data();S(tr.role),N(tr.displayName||"Unknown")}else S(null)}),Zt=th(vr(ir,"bars",u),Ke=>{if(Ke.exists()){const tr=Ke.data();m(tr.name),tr.buttons&&D([...x0,...tr.buttons])}}),er=th(EO(W_(ir,"requests"),IO("barId","==",u),TO("timestamp","desc")),Ke=>y(Ke.docs.map(tr=>({id:tr.id,...tr.data()}))));return()=>{Jt(),Zt(),er()}},[t,u,U,l]),Q.useEffect(()=>(w.current&&clearTimeout(w.current),_.length>0&&(w.current=setTimeout(()=>{const q=_.map(ee=>ee.label).join(": ");it(`${q} (Ask Me)`),v([])},6e4)),()=>{w.current&&clearTimeout(w.current)}),[_]);const C=async(q,ee)=>{!t||!u||(await Rl(vr(ir,`bars/${u}/users`,t.uid),{role:q,displayName:ee,email:t.email,status:"active",joinedAt:Jn(),lastSeen:Jn()},{merge:!0}),U&&await Rl(vr(ir,`bars/${u}/tokens`,t.uid),{token:U,updated:Jn()}))},I=async()=>{!t||!u||(await CO(vr(ir,`bars/${u}/tokens`,t.uid)),await eh(vr(ir,`bars/${u}/users`,t.uid),{status:"off_clock"}),f(null),localStorage.removeItem("barId"),A(!1))},it=async q=>{!t||!u||(navigator.vibrate&&navigator.vibrate(100),await kO(W_(ir,"requests"),{barId:u,label:q,requesterId:t.uid,requesterName:P,requesterRole:T,status:"pending",timestamp:Jn(),lastNotification:Jn()}))},Rr=async q=>{await eh(vr(ir,"requests",q),{status:"claimed",claimedBy:t==null?void 0:t.uid,claimerName:P})},Kn=async q=>{q.preventDefault();const ee=new FormData(q.target);try{i?await sR(fs,ee.get("email"),ee.get("password")):await aR(fs,ee.get("email"),ee.get("password"))}catch(fe){n(fe.message)}},Xt=async()=>{try{await PR(fs,aL)}catch(q){n(q.message)}};if(!t)return F.jsxs("div",{className:"min-h-screen flex flex-col items-center justify-center p-6 space-y-8 bg-black",children:[F.jsx("h1",{className:"text-4xl font-bold tracking-widest text-white",children:"BARBACKER"}),r&&F.jsx("div",{className:"text-red-400 p-2 border border-red-800 rounded",children:r}),F.jsxs("form",{onSubmit:Kn,className:"w-full max-w-sm space-y-4",children:[F.jsx("md-filled-text-field",{label:"Email",name:"email",type:"email",required:!0}),F.jsx("md-filled-text-field",{label:"Password",name:"password",type:"password",required:!0}),F.jsx("md-filled-button",{type:"submit",children:i?"Create Account":"Clock In"})]}),F.jsxs("div",{className:"flex gap-4 items-center",children:[F.jsx("md-text-button",{onClick:()=>o(!i),children:i?"Login":"Register"}),F.jsxs("md-outlined-button",{onClick:Xt,children:[F.jsx("md-icon",{slot:"icon",children:"mail"}),"Google"]})]})]});if(!u)return F.jsxs("div",{className:"min-h-screen flex flex-col items-center justify-center p-6 space-y-6 bg-black",children:[F.jsxs("div",{className:"text-center",children:[F.jsx("h2",{className:"text-2xl font-bold text-white mb-1",children:"Select Bar"}),F.jsxs("p",{className:"text-gray-500 text-sm",children:["You are ",t.email]})]}),F.jsx("md-text-button",{onClick:()=>dR(fs),children:"Sign Out"}),F.jsx(d4,{onJoin:async q=>{q.id&&(q.status==="temporary"&&await Rl(vr(ir,"bars",q.id),{name:q.name,address:q.address||"",status:"temporary",buttons:[]},{merge:!0}),f(q.id))}})]});if(!T)return F.jsxs("div",{className:"min-h-screen flex flex-col items-center justify-center p-6 space-y-6 bg-black",children:[F.jsx("md-icon-button",{onClick:()=>{f(null),localStorage.removeItem("barId")},children:F.jsx("md-icon",{children:"arrow_back"})}),F.jsx(h4,{onSelect:C})]});const H=b.filter(q=>q.status==="pending"),Z=b.filter(q=>q.status!=="pending").slice(0,20),ie=_.length>0?_[_.length-1].children||[]:x;return F.jsxs("div",{className:"min-h-screen pb-24 bg-black relative overflow-hidden",children:[F.jsxs("md-dialog",{open:E,onClose:()=>A(!1),children:[F.jsx("div",{slot:"headline",children:"Abandon Ship?"}),F.jsx("div",{slot:"content",children:"Going off clock stops all notifications. The bar will be unprotected. Are you sure?"}),F.jsxs("div",{slot:"actions",children:[F.jsx("md-text-button",{onClick:()=>A(!1),children:"Stay"}),F.jsx("md-filled-button",{onClick:I,class:"btn-alert",children:"Leave"})]})]}),F.jsxs("div",{className:"flex justify-between items-center p-4 bg-[#121212] sticky top-0 z-10 border-b border-[#333]",children:[F.jsxs("div",{className:"flex flex-col",children:[F.jsx("span",{className:"font-bold text-lg text-white tracking-wide",children:p}),F.jsxs("div",{className:"flex items-center gap-2 text-xs text-gray-400",children:[F.jsx("span",{className:"text-white font-bold",children:P}),F.jsx("span",{className:"bg-gray-800 px-1 rounded",children:T})]})]}),F.jsx("div",{className:"flex gap-2",children:F.jsx("md-icon-button",{onClick:()=>A(!0),title:"Go Off Clock",children:F.jsx(c4,{className:"text-gray-500 hover:text-red-500"})})})]}),_.length>0&&F.jsxs("div",{className:"fixed inset-0 bg-black/95 z-50 flex flex-col p-6 animate-in fade-in duration-300",children:[F.jsxs("div",{className:"flex items-center gap-4 mb-8",children:[F.jsx("md-icon-button",{onClick:()=>v([]),children:F.jsx("md-icon",{children:"close"})}),F.jsx("span",{className:"text-xl font-medium text-gray-200",children:_.map(q=>q.label).join(" > ")})]}),F.jsx("div",{className:"grid grid-cols-2 gap-4",children:ie.map(q=>F.jsx("md-filled-tonal-button",{onClick:()=>{q.children?v([..._,q]):(it([..._,q].map(ee=>ee.label).join(": ")),v([]))},style:{height:"100px",fontSize:"18px"},children:q.label},q.id))})]}),F.jsx("div",{className:"grid grid-cols-2 gap-3 p-4",children:x.map(q=>{const ee=H.some(fe=>fe.label.startsWith(q.label));return F.jsx("md-filled-tonal-button",{onClick:()=>{q.children?v([..._,q]):it(q.label)},class:ee?"btn-alert":"",style:{height:"120px"},children:F.jsxs("div",{className:"flex flex-col items-center gap-2",children:[F.jsx("md-icon",{style:{fontSize:32},children:q.icon||"circle"}),F.jsx("span",{className:"text-lg font-bold leading-none",children:q.label}),ee&&F.jsx("span",{className:"text-xs opacity-80",children:"PENDING"})]})},q.id)})}),F.jsx("div",{className:"px-4 mt-4",children:H.map(q=>F.jsxs("div",{onClick:()=>Rr(q.id),className:"mb-2 p-4 bg-[#2C1A1A] border-l-4 border-red-500 rounded-r-lg flex justify-between items-center cursor-pointer active:bg-red-900/40 transition-colors",children:[F.jsxs("div",{className:"flex flex-col",children:[F.jsx("span",{className:"font-medium text-red-100",children:q.label}),F.jsxs("span",{className:"text-xs text-red-400",children:[q.requesterName," (",q.requesterRole,")"]})]}),F.jsx("md-filled-button",{class:"btn-alert",style:{height:"32px"},children:"CLAIM"})]},q.id))}),F.jsxs("div",{className:"px-4 mt-8 pb-10",children:[F.jsx("div",{className:"text-xs font-bold text-gray-600 mb-2 uppercase tracking-widest",children:"Shift Log"}),F.jsx("md-list",{className:"bg-transparent",children:Z.map(q=>F.jsxs("md-list-item",{children:[F.jsx("div",{slot:"headline",className:"text-gray-400",children:q.label}),F.jsxs("div",{slot:"supporting-text",className:"text-xs text-gray-600",children:["Asked by ",q.requesterName," • Claimed by ",q.claimerName||"Someone"]}),F.jsx("md-icon",{slot:"start",className:"text-green-800",children:"check_circle"})]},q.id))})]})]})}Fb(document.getElementById("root")).render(F.jsx(Q.StrictMode,{children:F.jsx(PC,{children:F.jsx(f4,{})})}));
